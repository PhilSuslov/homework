...
import (
	...
	"github.com/PhilSuslov/homework/platform/pkg/testcontainers"
	"github.com/PhilSuslov/homework/platform/pkg/testcontainers/app"
	"github.com/PhilSuslov/homework/platform/pkg/testcontainers/mongo"
	"github.com/PhilSuslov/homework/platform/pkg/testcontainers/network"
	"github.com/PhilSuslov/homework/platform/pkg/testcontainers/path"
...
func setupTestEnvironment (ctx context.Context) *TestEnvironment {
	...
	if err != nil{
		...
		logger.Fatal(ctx, "Не удалось заупстить контейнер MongoDB", zap.Error(err))
	}

	logger.Info(ctx, "✅ Контейнер MongoDB успешно запушен")
