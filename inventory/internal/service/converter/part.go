...
func GetPartResponseNoteToRepoModel(service model.Note) repoModel.Note{
	return repoModel.Note{
		OrderUUID: service.OrderUUID,
		Body: GetPartResponseToRepoModel(service.Body),
	}
}

func RepoModelNoteToModel(service repoModel.Note) model.Note{
	return model.Note{
		OrderUUID: service.OrderUUID,
		Body: GetPartResponseToModel(service.Body),
	}
}
...
func GetPartResponseNoteToModel(repo repoModel.GetPartResponse) model.GetPartResponse {
	return model.GetPartResponse{
		Part: RepoModelNoteToModel(repo.Part),
	}
}
...
func ListPartsRequestNoteToRepoModel(info model.ListPartsRequest) repoModel.ListPartsRequest {
	return repoModel.ListPartsRequest{
		Filter: PartsFilterToRepoModel(info.Filter),
	}
}

func ListPartsRequesNotetToModel(repo repoModel.ListPartsRequest) model.ListPartsRequest {
	return model.ListPartsRequest{
		Filter: PartsFilterToModel(repo.Filter),
	}
}
...
func ListPartsResponseNotesToNote(repo []repoModel.Note) []model.Note {
	var res []model.Note
	for _, v := range repo {
		res = append(res, RepoModelNoteToModel(v))
	}
	return res
}

func GetPartRequestToModel(service model.GetPartRequest) repoModel.GetPartRequest {
